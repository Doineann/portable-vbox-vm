...
"%VBOX_INSTALL_DIR%\VBoxManage.exe" storageattach "%VM_VBOX_UUID%" --storagectl SATA --port 0 --type hdd --medium "%VM_DIR%\%VM_HDD_FILE%" --mtype immutable --nonrotational on --discard on